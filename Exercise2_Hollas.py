...
class Shape(list[Point, ...]):
    ...
    def centroid(self) -> Point:
        ...
        number_of_points = len(self)

        centroid_x = total_x / number_of_points
        centroid_y = total_y / number_of_points
...
class Canvas:
    ...
    def draw_polygon(self, *points: tuple[int, int], closed: bool = True, line_char: str = "*"):
        def draw_line_segment(start: tuple[int, int], end: Point, line_char: str = "*"):
